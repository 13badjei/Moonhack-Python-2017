...
if "I" not in user_list:
  print("You will not make it to the moon base without food. Yoou will need yourr energy to drive the rover.")
...
if "A" in user_list and "E" in user_list and "F" in user_list and "I" in user_list:
  ...
  print("You did not pick the correct 4 items for survival. You will not make it safely tto the moon base.")